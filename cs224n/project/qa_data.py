...
def setup_args():
    ...
    parser.add_argument("--glove_tokens", default="840B")
...
def process_glove(args, vocab_list, save_path, size=4e5, random_init=True):
    ...
    if not gfile.Exists(save_path + ".npz"):
        glove_path = os.path.join(args.glove_dir, "glove.{}.{}d.txt".format(args.glove_tokens, args.glove_dim))
        if random_init:
...
if __name__ == '__main__':
    ...
    process_glove(args, vocab, args.source_dir + "/glove.trimmed.{}.{}".format(args.glove_tokens, args.glove_dim),
